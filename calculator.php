...
<section id="form-section">
  ...
  <form action="./forms/calculator-form.php" method="POST" id="calculator-form">
    ...
    <input type="number" id="weight" name="weight" placeholder="Ingrese su peso" required aria-label="Peso en kilogramos" min="1" value="<?php if (isset($weight)) echo $weight; ?>" />

    <label for="height">Altura (en centímetros):</label>
    <input type="number" id="height" name="height" placeholder="Ingrese su altura" required aria-label="Altura en centímetros" min="1" value="<?php if (isset($height)) echo $height; ?>" />

    <label for="age">Edad:</label>
    <input type="number" id="age" name="age" placeholder="Ingrese su edad" required aria-label="Edad" min="1" value="<?php if (isset($age)) echo $age; ?>" />
    ...
    <select id="activity-level" name="activity-level" required aria-label="Nivel de actividad">
    ...
    <input type="submit" value="Calcular" aria-label="Calcular las calorías y macro-nutrientes" name="calculate" id="calculate-submit-button" />
  </form>
</section>
</main>
